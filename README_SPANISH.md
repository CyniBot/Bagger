...
| bagger.reset   | resetbagger |

## Configuración

Cuando el servidor se reinicie después de pegar el plugin en la carpeta ServerPlugins, se creará un archivo de configuración en la carpeta tshock. <br>
